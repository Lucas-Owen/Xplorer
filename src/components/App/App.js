    ...
    <div className="App">
      ...
      <div className='App-body'>
        ...
        <p>
          ...
          So, whether you're dreaming of sipping chai in a Marrakech riad or chasing the Northern Lights in Iceland, Wanderlust Explorer is your gateway to wanderlust fulfilled. Bon voyage!
        </p>
        <h2>Let's Go!</h2>
