      ...
      <div className='App-footer'>
        ...
        <div className='socials'>
          <div className="social-link-container">
            <a href="https://twitter.com/Sanguralucas" target='_blank' rel='noreferrer' referrerPolicy='no-referrer' className="social-link"><Twitter /></a>
          </div>
          <div className="social-link-container">
            <a href="www.linkedin.com/in/lucas-sangura" target='_blank' rel='noreferrer' referrerPolicy='no-referrer' className="social-link"><Linkedin /></a>
          </div>
          <div className="social-link-container">
